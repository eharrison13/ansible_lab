...
Function Get-V238024 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238024
        STIG ID    : DTOO182
        Rule ID    : SV-238024r879887_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : The Help Improve Proofing Tools feature for Office must be configured.
        DiscussMD5 : 0D0BE1683EAD873E65ECB316047BBF70
        CheckMD5   : B8D1624FBCAE5E17B060F49DA26DE60A
        FixMD5     : 728F2550660E8838E6B8DCFE741C0F12
    #>
...
Function Get-V238025 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : C452F3F8E54E129E17D10EB49940983C
        CheckMD5   : 2AE4F6DD3BFB7ED7BE27E1AC7A72CAF3
        FixMD5     : AC6A5A0F3BA54C8C1C8E7EBF16F83C13
    #>
...
Function Get-V238026 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238026
        STIG ID    : DTOO187
        Rule ID    : SV-238026r879800_rule
        CCI ID     : CCI-002476
        Rule Name  : SRG-APP-000429
        Rule Title : Rights managed Office Open XML files must be protected.
        DiscussMD5 : 5F77A7C85A74EF5EFAA4C406072622A9
        CheckMD5   : 02DCF863D8DF05662D4297D4E512C771
        FixMD5     : 926061E131CB3A7E9401428EDF6D42CF
    #>
...
Function Get-V238027 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238027
        STIG ID    : DTOO188
        Rule ID    : SV-238027r879642_rule
        CCI ID     : CCI-001199
        Rule Name  : SRG-APP-000231
        Rule Title : Document metadata for password protected files must be protected.
        DiscussMD5 : 382B07D2614FD34C078D7AAFA16B1B9B
        CheckMD5   : 2AD4B32B62975A7D2CAF8E0F81196B7D
        FixMD5     : F467A5043AB52B1293ECF7CA4B163B9B
    #>
...
Function Get-V238028 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238028
        STIG ID    : DTOO189
        Rule ID    : SV-238028r879642_rule
        CCI ID     : CCI-001199
        Rule Name  : SRG-APP-000231
        Rule Title : The encryption type for password protected Open XML files must be set.
        DiscussMD5 : AF749730F0977B139D9A6559DFB9C70E
        CheckMD5   : 03F988AA4A4E3877E7CA4023CFDB8CE4
        FixMD5     : F7B1F3DA7B07994E87563EE3121FC699
    #>
...
Function Get-V238029 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238029
        STIG ID    : DTOO190
        Rule ID    : SV-238029r879642_rule
        CCI ID     : CCI-001199
        Rule Name  : SRG-APP-000231
        Rule Title : The encryption type for password protected Office 97 thru Office 2003 must be set.
        DiscussMD5 : 82ADB70F80CEB2C736525B16C7183CEB
        CheckMD5   : 34B3FB762D9E2AAADCC664F2AD5A7D4D
        FixMD5     : AB289A7D8EEB12141320D2B112553713
    #>
...
Function Get-V238030 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238030
        STIG ID    : DTOO191
        Rule ID    : SV-238030r879859_rule
        CCI ID     : CCI-002460
        Rule Name  : SRG-APP-000488
        Rule Title : ActiveX control initialization must be disabled.
        DiscussMD5 : 2A54C9E13D80146FEE7D63B93C71C7C0
        CheckMD5   : A48B346107D15750F9EE1254C05DBF0B
        FixMD5     : 14435C624DFE9451FD4DFC21ECFD23D6
    #>
...
Function Get-V238031 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238031
        STIG ID    : DTOO192
        Rule ID    : SV-238031r879628_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
        Rule Title : Load controls in forms3 must be disabled from loading.
        DiscussMD5 : C05EC0255E29F91F5E825BDDEE3BA5D1
        CheckMD5   : 9F80DB541C894CD66D63B316E5C2DC74
        FixMD5     : F0A1CC7412E04F08D5EF6496C9671FDF
    #>
...
Function Get-V238032 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 3AFE43F89D1A461987816FA63D9E4E55
        CheckMD5   : 5DADDA641B7F4AA66F0506E8445F6F10
        FixMD5     : 941CC217DF927C0645FF1FFEFFF8DBF8
    #>
...
Function Get-V238033 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238033
        STIG ID    : DTOO196
        Rule ID    : SV-238033r879887_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : A mix of policy and user locations for Office Products must be disallowed.
        DiscussMD5 : 2C21A521C004305D3624DD5FA01BACAD
        CheckMD5   : 8FEA0DC040FE477F065887BC49503E72
        FixMD5     : 8AC27EE355CFC378208703ACB0B50CE0
    #>
...
Function Get-V238034 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238034
        STIG ID    : DTOO197
        Rule ID    : SV-238034r879887_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : Smart Documents use of Manifests in Office must be disallowed.
        DiscussMD5 : F405C184B31D4642315AC2C766E08CC8
        CheckMD5   : 452390DF8DEC3BDA9426D541B62A85DC
        FixMD5     : 9B0585C8ABEEF9ED0AE73BDD782E4D49
    #>
...
Function Get-V238035 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238035
        STIG ID    : DTOO201
        Rule ID    : SV-238035r879717_rule
        CCI ID     : CCI-002235
        Rule Name  : SRG-APP-000340
        Rule Title : Connection verification of permissions must be enforced.
        DiscussMD5 : 5AA55FC6D9C4A06DC83DF1DB614DAB3B
        CheckMD5   : 9EDBA37AB56D597992985B26B9FEEDC8
        FixMD5     : 5041432874BD0761373C61D3B69975A2
    #>
...
Function Get-V238036 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238036
        STIG ID    : DTOO206
        Rule ID    : SV-238036r879887_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : Inclusion of document properties for PDF and XPS output must be disallowed.
        DiscussMD5 : FBA17F8AC71CD38BB5CF668C3B215544
        CheckMD5   : 1B11D8562D02DD506BC473FCC1FA4748
        FixMD5     : 29487EECABBB3B3F10738A01238E1145
    #>
...
Function Get-V238037 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238037
        STIG ID    : DTOO321
        Rule ID    : SV-238037r879800_rule
        CCI ID     : CCI-002476
        Rule Name  : SRG-APP-000429
        Rule Title : Encrypt document properties must be configured for OLE documents.
        DiscussMD5 : 77D60002B7782364D536045FFDB8A5AA
        CheckMD5   : 7B004C6654196D56D2261DECD15E2DFC
        FixMD5     : C5334A7DD5C6D0E189B943EEFBF9C73B
    #>
...
Function Get-V238038 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 1A8D078692A8FF8389F267E41804A686
        CheckMD5   : EE429518D9738017B3DC1B070CC72A33
        FixMD5     : FFA89CB7BE893111526EAD18E359818C
    #>
...
Function Get-V238039 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 1BC5511C4EAF0D4A031BFFC4A4988ED7
        CheckMD5   : E40C2D46BB18BB0F8CC90F851FCB84EF
        FixMD5     : B749AA7402B8BFE662A81B2BBA5604FE
    #>
...
Function Get-V238040 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238040
        STIG ID    : DTOO410
        Rule ID    : SV-238040r953849_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : When using the Office Feedback tool, the ability to include a screenshot must be disabled.
        DiscussMD5 : F61FC260073ACE8EA3C01BC4B13EACD3
        CheckMD5   : 69323CAEDF3295E90D399195684B5D05
        FixMD5     : 5A72D485B7575B753B05E089E515915F
    #>
    ...
    $RegistryValue = @("0")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Allow users to include screenshots and attachments when they submit feedback to Microsoft"  # GPO setting name identified in STIG
    $SettingState = "Disabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V238041 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238041
        STIG ID    : DTOO412
        Rule ID    : SV-238041r879887_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : The ability to run unsecure Office web add-ins and Catalogs must be disabled.
        DiscussMD5 : B0425EE9D44AAA6870A1F4944D2DB6DB
        CheckMD5   : FEE3CB276EA684FF1DDB1798BF96C9E6
        FixMD5     : 7B4C8627E963A6699E385C9E59CE4A29
    #>
...
Function Get-V238042 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 5B52CDEF089953430B1F13BA57FE1655
        CheckMD5   : 794B323EBFB063730EE2EF5EA6C534E7
        FixMD5     : 30B61D806A78BE3D3B8E324CC798157F
    #>
...
Function Get-V238043 {
    ...
    .DESCRIPTION
        Vuln ID    : V-238043
        STIG ID    : DTOO601
        Rule ID    : SV-238043r879887_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : The ability to send personal information to Office must be disabled.
        DiscussMD5 : 1953C32683C0C2708791FE410C0141C5
        CheckMD5   : BD62BC43D3A40E033FD238822FDC3BA5
        FixMD5     : 14887D9ADE17F751614C866885416641
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQoSq54LdmBnMC
# tfftFw5xZTKfuYodxGi4AzIB9p5bvKCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCLlgRog8ZcTGUxvoH9PbtuW15vwC//
# 3umg2hzpRZnINzANBgkqhkiG9w0BAQEFAASCAQA71D2pAMCocY6KD0PgtrB4CvBT
# CvRq8t4oQu3wgnQM0ERT1oH1ZUvSzu1gEshQguiAgOcy1ntw5G7z/WF1qr5nbN3I
# J0zURN159+vZh9YydzX97oxTFiPtB8kdEtMSJeFt9WiypVd00QyepfPpQhxEaaAR
# wZw/LRU9w2IFcOlo8dg6fMj3T3VIT2O7Ylf8JqhhqnIQm1APsinkdvutIT4Uqckl
# StUxPTzeopbsHqzJQf4wQjA9644OokF99LiIIv5fc78XTTkt5t+wqTq9or5TadPO
# as43YtV5svuSDkGfQjYskulRrLOnaqKMuJu5aL+4SuYD6C2yrSojrPbpWAG4
